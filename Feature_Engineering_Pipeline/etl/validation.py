...
def build_exoectation_suite() -> ExpectationSuite:
    """
    ...
    expectation_suite_energy_consumption.add_expectation(
        ExpectationConfiguration(
            ...
            kwargs={
                ...
                "value_set": (111, 112, 119, 121, 122, 123, 130, 211, 212,
                              215, 220, 310, 320, 330, 340, 350, 360, 370, 
                              381, 382, 390, 410, 421, 422, 431, 432, 433, 
                              441, 442, 443, 444, 445, 446, 447, 450, 461, 
                              462, 999)
            }
        )
    ...
    expectation_suite_energy_consumption.add_expectation(
        ExpectationConfiguration(
            expectation_type="expect_coluumn_values_to_be_of_type",
